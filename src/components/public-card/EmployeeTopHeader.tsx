...
const LANG_BTN_INACTIVE = 'text-white/85 hover:text-white'
...
export function EmployeeTopHeader({
	...
	return (
		<header className="sticky top-0 z-40">
			<div className="relative border-b border-yellow-300/25 bg-black/[0.06] backdrop-blur-[1px] md:bg-black/10 md:backdrop-blur-2xl">
				...
				<div className="mx-auto flex max-w-[1320px] flex-wrap items-center gap-3 px-4 py-3 sm:gap-4 sm:px-5 sm:py-4 lg:px-6 lg:py-5">
					<div className="flex min-w-0 flex-1 items-center gap-3 sm:gap-4">
						<div className="relative shrink-0">
							...
							<div
								className={cn(
									'relative grid h-14 w-14 place-items-center overflow-hidden rounded-2xl border border-yellow-300/35 bg-black/[0.04] backdrop-blur-[1px] shadow-[0_15px_45px_rgba(0,0,0,0.30)] md:bg-black/10 md:backdrop-blur-xl sm:h-16 sm:w-16 lg:h-20 lg:w-20'
								)}
							>
								{organizationLogoUrl ? (
									<img
					...
					<div className="flex w-full items-center justify-between gap-3 sm:w-auto sm:gap-4">
						<div className="flex items-center gap-2">
							<Globe2 className="h-4 w-4 text-yellow-200/85 sm:h-[18px] sm:w-[18px]" aria-hidden="true" />
						...
						<div className="hidden items-center gap-2.5 rounded-2xl border border-yellow-300/25 bg-black/[0.04] px-2.5 py-1.5 shadow-[0_8px_24px_rgba(0,0,0,0.25)] backdrop-blur-[1px] md:bg-black/10 md:backdrop-blur-xl sm:flex">
							...
							<div className="hidden min-w-0 md:block">
								<div className="truncate text-xs font-semibold leading-tight text-white drop-shadow-[0_1px_8px_rgba(0,0,0,0.75)]">{fullName}</div>
								<div className="truncate text-[10px] leading-tight text-yellow-200/85 drop-shadow-[0_1px_8px_rgba(0,0,0,0.75)]">{position ?? ''}</div>
							</div>
						</div>
					</div>
				</div>
